            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <h2 class="wow fadeInUp" data-wow-delay=".4s">Meet Our Sponsors</h2>
                        <p class="wow fadeInUp" data-wow-delay=".6s">Our TEDxJumeirahbeachpark sponsors are visionary thinkers, innovators, and storytellers who bring fresh perspectives and powerful ideas to the stage. Coming from diverse backgrounds and industries, they are united by a passion for sparking meaningful conversations and inspiring change.</p>
                    </div>
                </div>
            </div>
